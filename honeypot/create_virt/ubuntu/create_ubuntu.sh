...
OSVAR="--os-variant=ubuntuprecise"
VIRTTYPE="--virt-type kvm"
...
#KSfile="--initrd-inject=./preseed.cfg"
KSfile="--initrd-inject=/home/badger1/honeypot/client/create_virt/ubuntu/preseed.cfg"

# Optionally add a URL for a kickstart file:
KS=""
#KS="--extra-args 'file=/ubuntu.cfg'"
...
#echo virt-install $OSTYPE $OSVAR $Net $KSfile $KS $Disk $Src $Gr $Cpu $Ram $Arch $Serial $Console --name=$Name --noautoconsole $Extra
#virt-install $OSTYPE $OSVAR $Net $KSfile $KS $Disk $Src $Gr $Cpu $Ram $Arch $Serial $Console --name=$Name --video=vga --noautoconsole $Extra

echo virt-install $OSTYPE $OSVAR $VIRTTYPE $Net $Disk $Src $KSfile $KS $Gr $Cpu $Ram $Serial $Console --name=$Name --noautoconsole \
...
virt-install $OSTYPE $OSVAR $VIRTTYPE $Net $Disk $Src $KSfile $KS $Gr $Cpu $Ram $Serial $Console --name=$Name --video=vga --noautoconsole \
--extra-args "ks=file:/preseed.cfg"
#console=ttyS0,115200
#auto=true 
#priority=critical 
